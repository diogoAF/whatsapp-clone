...
export default class Message extends Model {
    ...
    /**
    * Retorna a DIV configurada já com a mensagem final,
    * @sending determina se a mensgaem foi enviada ou recebida pelo usuário
    */
    getViewElement(sending = true) {
                                ...
                                <div class="_1QMEq _1kZiz fS1bA">
                                    ...
                                    <div class="_1_Gu6">
                                        ...
                                        <div class="_1sLSi">
                                            ...
                                            <audio id="audio-microphone" src="#" preload="auto"></audio>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        let className = (sending) ? 'message-out' : 'message-in';
